  ...
  <div id="app">
    <div class="head-box head-box-generate" style="margin-top: 1rem">
      ...
      <p style="font-size: 15px; color: green">
        *แบบสำรวจนี้ เป็นการสอบถามความสนใจเท่านั้น มิใช่การสั่งจอง
        หรือลำดับการจอง
      </p>
      <br />
      <p style="font-size: 20px; font-weight: bold; color: green">
        Sign up to receive information about an alternative COVID-19 Vaccine
        available Q2/2022
      </p>
      <br />
      <p style="font-size: 15px; color: green">
...
export default {
  ...
  methods: {
    ...
    async GenerateQRCode() {
      ...
      this.codeValue =
        `${window.location.href}?page=Register&token=` + this.codeValue;
